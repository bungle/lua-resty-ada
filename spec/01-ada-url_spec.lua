...
describe("Ada", function()
  describe("URL", function()
    ...
    describe(":free", function()
      it("works", function()
        local u = ada.parse("https://www.google.com?doge=z&jack=2&doge=s")
        assert.equal("www.google.com", u:get_hostname())
        u:free()
        assert.errors(function() u:get_hostname() end, "attempt to call method 'get_hostname' (a nil value)")
      end)
    end)
  end)
  describe("Search", function()
    describe(":free", function()
      it("works", function()
        ...
        assert.equal("2", s:get("jack"))
        s:free()
        assert.errors(function() s:get("jack") end, "attempt to call method 'get' (a nil value)")
      end)
    end)
  end)
end)
